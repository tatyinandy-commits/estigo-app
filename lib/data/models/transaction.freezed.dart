...
class _$TransactionImpl implements _Transaction {
  ...
  @override
  String toString() {
    return 'Transaction(id: $id, type: $type, amount: $amount, description: $description, date: $date, status: $status, roomNumber: $roomNumber, shares: $shares)';
  }
...
abstract class _Transaction implements Transaction {
  const factory _Transaction(
      ...
      final TransactionStatus status,
      final String? roomNumber,
      final int? shares}) = _$TransactionImpl;
